...
for distance = 0:1:1000
    ...
    % Joules
    mission.energy_required_multimodal = ((MR.drop_current_draw_)+DM.total_ampere_draw_+FW.cruise_current_required+MR.cruise_current_required_+(MR.climb_current_draw_))*motor.reference_voltage_;
